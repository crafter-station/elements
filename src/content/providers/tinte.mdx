  ...
  <div className="flex items-center justify-center min-h-[400px] relative">
    <div className="flex flex-col items-center gap-4">
      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary">
        <span className="text-sm font-medium">Check the bottom right corner</span>
        <svg className="w-4 h-4 -rotate-45 animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <body>
        {children}
        {process.env.NODE_ENV === "development" && <TinteEditor />} // [!code highlight]
      </body>
    </html>
  );
}
