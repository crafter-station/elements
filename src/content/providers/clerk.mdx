...
<ComponentPreviewItem
  componentKey="clerk-sign-in-signals"
  installUrl="@elements/clerk-sign-in-signals"
  category="Authentication"
  name="Clerk"
>
  <SignInSignals />
...
**Key Differences:** `useSignInSignal()` hook, field-level errors, built-in reset flow
...
<ComponentPreviewItem
  componentKey="clerk-sign-up-signals"
  installUrl="@elements/clerk-sign-up-signals"
  category="Authentication"
  name="Clerk"
>
  <SignUpSignals />
