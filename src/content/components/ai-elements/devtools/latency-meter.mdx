---
title: Latency Meter
description: Display API response timing with visual breakdown of TTFB, streaming, and total time
---

<ComponentPreviewItem
  componentKey="latency-meter"
  installUrl="@elements/latency-meter"
  category="AI"
  name="Latency Meter"
>
  <LatencyMeter />
