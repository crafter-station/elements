...
export interface RooCodeLogoProps extends React.SVGProps<SVGSVGElement> {}

export function RooCodeLogo({ className, ...props }: RooCodeLogoProps) {
  return (
    <svg
